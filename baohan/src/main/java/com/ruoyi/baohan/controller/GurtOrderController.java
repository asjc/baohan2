...
public class GurtOrderController extends BaseController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(GurtOrder gurtOrder, String[] fileNames, String[] fileUrls, String[] money)throws Exception {
        ...
        Map map = Replace.getMap(gurtOrder,iGurtProjectTypeService,gurtOrderService);
        String newpath = Global.getUploadPath() +
                baourl.substring(baourl.lastIndexOf("/"), baourl.lastIndexOf("/"))
                + gurtOrder.getProjectName()+ gurtOrder.getWarrantee()
                + ".docx";
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(GurtOrder gurtOrder, String[] fileNames, String[] fileUrls, String[] money)throws Exception {
        GurtGuarantee gurtGuarantee = iGurtGuaranteeService.selectGurtGuaranteeById(gurtOrder.getGuaranteeId());
        String baourl = gurtGuarantee.getGuaranteeFilePath();
        String ab = Global.getUploadPath() + baourl.substring(baourl.lastIndexOf("/"));
        Map map = Replace.getMap(gurtOrder,iGurtProjectTypeService,gurtOrderService);
